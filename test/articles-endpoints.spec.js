    ...
    describe(`POST /articles`, () => {
        it(`creates an article, responding with 201 and the new article`,  function() {
            ...
            return supertest(app)
                ...
                //validate that both response bodies 
                //(the POST response body and the GET response body) match
                //used an implicit return inside .then()
                //so Mocha waits for both requests to resolve
                .then(postRes => 
                    supertest(app)
        ...
        //LINES 150-170 IS REFACTORED FROM ABOVE
